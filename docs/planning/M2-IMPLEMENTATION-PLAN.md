...
M2.3 consumes the controlled `query-result/0.1.1` correction and the
authoritative corrected v3 M1 Draft package fixture; it does not change M1
vectors or generate a release artifact.
