...
| M3 — Method evaluation | **Planned.** Produce evidence, not feature demonstrations. | M1/M2; OQ-04/05/08 as applicable; ADR-009/014 accepted. | Preregistered studies, versioned cohorts/baselines, exact ground truth where applicable, raw result artifacts, uncertainty/failure analysis, decision ADRs. | Each claim is scoped to its preregistered evidence. No default profile/index/bridge/graph method is promoted without required baselines and review. |
